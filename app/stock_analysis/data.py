...
_SP500_TICKERS = [
    ...
    "BMY", "AVGO", "BR", "BRO", "BF.B", "BLDR", "BSX", "BWA", "CHRW",
    "CDNS", "CZR", "CPT", "CPB", "COF", "CAH", "KMX", "CCL", "CARR", "CAT",
    "CBOE", "CBRE", "CDW", "CE", "COR", "CNC", "CNP", "CF", "CHTR", "CVX",
    ...
    "DAL", "DVN", "DXCM", "FANG", "DLR", "DG", "DLTR", "D", "DPZ",
    ...
    "FDX", "FIS", "FITB", "FSLR", "FE", "FTV", "FOXA", "FOX", "BEN", "FCX",
    ...
    "INCY", "IR", "PODD", "INTC", "ICE", "IFF", "IP", "INTU", "ISRG", "IVZ",
    "INVH", "IQV", "IRM", "JBHT", "JBL", "JKHY", "J", "JNJ", "JCI", "JPM",
    "K", "KVUE", "KDP", "KEY", "KEYS", "KMB", "KIM", "KMI", "KLAC", "KHC",
    "KR", "LHX", "LH", "LRCX", "LW", "LVS", "LDOS", "LEN", "LIN", "LYV",
    ...
    "V", "VST", "VMC", "WRB", "GWW", "WAB", "WMT", "DIS", "WBD",
